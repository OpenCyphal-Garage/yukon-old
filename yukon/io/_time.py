...
def to_dcs_timestamp(ts: pyuavcan.transport.Timestamp) -> uavcan.time.SynchronizedTimestamp_1_0:
    """
...
def from_dcs_timestamp(ts: uavcan.time.SynchronizedTimestamp_1_0) -> pyuavcan.transport.Timestamp:
    """
